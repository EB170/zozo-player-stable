...
export const VideoPlayerHybrid = ({
  ...
  const createHlsPlayer = useCallback(() => {
    ...
    const hls = createHlsInstance(videoEl, {
      ...
      maxBufferLength: 120,              // 90s buffer forward (très large)
      ...
      liveSyncDurationCount: 1,         // 5 segments du live (marge confortable)
      liveMaxLatencyDurationCount: 3,  // Max 12 segments retard (très tolérant)
      ...
      fragLoadingTimeOut: 60000,        // 20s timeout fragments
      levelLoadingTimeOut: 10000,
      manifestLoadingMaxRetry: 4,
      levelLoadingMaxRetry: 4,
      fragLoadingMaxRetry: 30,           // 6 tentatives par fragment
